...
const Testimonials: React.FC = () => {
  ...
  const testimonials = [
    {
      quote: "The free AI consultation was incredibly valuable. The Reusch AI Solutions team identified automation opportunities we hadn't even considered, with projected savings of over $50,000 annually.",
      author: "Sarah J.",
